...
public class JrServer {
    public static void main(String[] args) throws IOException {
        ...
        ServerSocket server2 = new ServerSocket(80);
        ...
        while (true) {
            ...
            if (start == 0) {
//                srvrMssg = "thanks for connection. Please Write your name with prefix name_";
                srvrMssg = "thanks for connection. Please Write your name";
                start++;
            } else if (start == 1) {
//            }if (clientMssg.contains("name") && start==1 ) {
                name = clientMssg;
//                name = clientMssg.replaceAll("name_","");
                srvrMssg = name + ", Are you child? (yes/no)";
                start++;
            } else if (start == 2) {
                if (clientMssg.contains("yes")) srvrMssg = "Welcome to the kids area, " + name + "! Let's play! ...you may type sms...";
...
//                mssg=  "это Сервер!. вы прислали текст: "+word;
